...
document.getElementById('password').parentElement.parentElement.insertAdjacentHTML('afterend', 
   '<tr>' + 
   '<td><label for="zeta-otp">雙因素驗證:</label></td>' + 
   '<td><input id="zeta-otp" class="zLoginField" type="text" value="" size="40" maxlength="1024" autocomplete="off" onkeypress="zetaCheckEnter(event);" placeholder="若此帳號未啟用雙因素驗證，請留空。"></td>' + 
   '</tr>'
);
